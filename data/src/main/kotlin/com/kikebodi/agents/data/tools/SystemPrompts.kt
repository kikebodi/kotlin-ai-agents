...
Productos:
- Optimización de CI (tests selectivos)
- Optimización de CI (refactorización de workflows)
- Agente de revisión de PRs
- Multi-agentes para desarrollo sobre Git
- App Conconi (Android)
- Librería Bluetooth (Android)

Pasos:
1) Clasifica cada sección como: Ayuda/Subvención, Licitación/Contrato, Programa o convocatoria, Otros (ignorar).
2) Extrae: título, entidad, resumen, presupuesto, plazo, referencia, URL, categoría, palabras clave.
